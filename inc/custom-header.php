 ...
 *
 * @uses wpacademy_header_style()
 */
function wpacademy_custom_header_setup() {
	add_theme_support(
		'custom-header',
		apply_filters(
			'wpacademy_custom_header_args',
			array(
				'default-image'      => '',
				...
				'height'             => 250,
				'flex-height'        => true,
				'wp-head-callback'   => 'wpacademy_header_style',
			)
		)
	);
}
add_action( 'after_setup_theme', 'wpacademy_custom_header_setup' );

if ( ! function_exists( 'wpacademy_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see wpacademy_custom_header_setup().
	 */
